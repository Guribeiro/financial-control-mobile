...
export const DocumentPickerText = styled.Text`
  color: ${({ theme }) => theme.palett.colors.text_primary_100};
  font-size: ${({ theme }) => theme.screen.rem(1.6, true)}px;
  line-height: ${({ theme }) => theme.screen.rem(2.6, true)}px;
  font-family: 'Roboto_400Regular';
`;

export const SelectedReceiptText = styled.Text`
  color: ${({ theme }) => theme.palett.colors.text_primary_100};
  font-size: ${({ theme }) => theme.screen.rem(1, true)}px;
  line-height: ${({ theme }) => theme.screen.rem(2, true)}px;
  font-family: 'Roboto_400Regular';
`;

export const TextEmphasized = styled(DocumentPickerText)`
